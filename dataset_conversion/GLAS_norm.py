...
# 源文件夹
src_dir = Path("/common/users/bg654/verse_dataset/Glas")  # 你的路径
# 目标文件夹
...
for fname in os.listdir(src_dir):
    if fname.endswith(".bmp"):
        ...
        # 判断是图像还是标注
        if "anno" in fname:
            # 去掉 _anno 并加上 _gt.png
            base_name = fname.replace("_anno.bmp", "")
            new_name = f"{base_name}_gt.png"
            save_path = ann_dir / new_name
        else:
            # 普通图像
...
print("✅ 转换完成！图像在 images/，标注在 annotations/")
...
source_path = "/common/users/bg654/verse_dataset/Glas/Data"
target_path = "/common/users/bg654/verse_dataset/Glas/Data/"
