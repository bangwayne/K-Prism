...
def process_3d_data(dataset_info, source_path, target_path, file="test"):
    ...
    all_files = os.listdir(os.path.join(file_path, "image"))
    nii_files = [f for f in all_files if f.endswith(".nii.gz") and not f.startswith("._")]
...
dataset_info = ('pancreas', 'ct')
# yaml_path = "/research/cbim/medical/bg654/verse_dataset/LITS/list/test.yaml"
# source_dir = "/research/cbim/medical/bg654/verse_dataset/LITS"
# target_path = "/research/cbim/medical/bg654/verse_dataset/LITS/rescale_data/test"
# # copy_yaml_file(yaml_path, source_dir, source_dir, target_path)
# # create_yaml("/research/cbim/medical/bg654/verse_dataset/LITS/list/dataset.yaml", save_dir="/research/cbim/medical/bg654/verse_dataset/LITS/list")
source_path = "/common/users/bg654/verse_dataset/Pancreas/raw_Data"
target_path = "/common/users/bg654/verse_dataset/Pancreas/Data/"
...
#             new_name = file.replace(".nii.gz", "_gt.nii.gz")
#             new_path = os.path.join(folder_path, new_name)
#             os.rename(old_path, new_path)
#             print(f"Renamed: {file} → {new_name}")
#
# rename_masks_to_gt("/common/users/bg654/verse_dataset/Pancreas/Data/test/labelsTr")