...
#         if file.endswith("_gt_gt.png"):
#             old_path = os.path.join(folder_path, file)
#             new_name = file.replace("_gt_gt.png", "_gt.png")
#             new_path = os.path.join(folder_path, new_name)
#             os.rename(old_path, new_path)
#             print(f"Renamed: {file} → {new_name}")
#
# rename_masks_to_gt("/common/users/bg654/verse_dataset/OAIZIB/Data/test/annotations")
...
process_existing_2d_data("/common/users/bg654/verse_dataset/OAIZIB/Data")
...
# dataset_info = ('DRIVE', 'untrosound')
# source_path = "/common/users/bg654/verse_dataset/DRIVE/rescale_data"
# target_path = "/common/users/bg654/verse_dataset/DRIVE/Data/"
