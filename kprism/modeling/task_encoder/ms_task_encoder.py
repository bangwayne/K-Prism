...
class MSTaskEncoder(nn.Module):
    def __init__(
        ...
        for _ in range(self.feat_scale):
        ...
        self.proj_conv = nn.Conv2d(192, in_channels, kernel_size=1)
        self.mask_conv = nn.Sequential(
            nn.Conv2d(1, in_channels // 2, kernel_size=3, stride=2, padding=1),
    ...
    def forward(self, ref_feat, ref_mask):
        """
        NOTE: this interface is experimental.
        Args:
