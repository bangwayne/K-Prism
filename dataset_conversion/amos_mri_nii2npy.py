...
# source_path = '/research/cbim/vast/bg654/Desktop/jupyproject/imask2former/datasets/AMOS/AMOS_MRI/rescale_data'
# target_path = 'npy'
#
...
# output_image_path = '/research/cbim/medical/bg654/verse_dataset/AMOS/AMOS_CT/rescale_data/train/image'
# output_gt_path = '/research/cbim/medical/bg654/verse_dataset/AMOS/AMOS_CT/rescale_data/train/Annotations'
...
#
#
# output_image_folder = '/research/cbim/medical/bg654/verse_dataset/AMOS/AMOS_CT/rescale_data/test/image'  # Change this to your image destination folder
# output_gt_folder = '/research/cbim/medical/bg654/verse_dataset/AMOS/AMOS_CT/rescale_data/test/Annotations'  # Change this to your ground truth destination folder
#
...
source_path = '/research/cbim/medical/bg654/verse_dataset/AMOS_MRI/rescale_data'
...
#
for dataset, modality in dataset_list:
    for name in os.listdir(os.path.join(train_source_path, "image")):
        # if 'gt' in name:
        idx = name.split('.nii.gz')[0]

        img = sitk.ReadImage(os.path.join(train_source_path, "image", f"{idx}.nii.gz"))
        img = sitk.GetArrayFromImage(img).astype(np.float32)
        lab = sitk.ReadImage(os.path.join(train_source_path, "annotations", f"{idx}_gt.nii.gz"))
        lab = sitk.GetArrayFromImage(lab).astype(np.int8)
        ...
        selected_slices = nonzero_slices
        #
        # # **Step 5: 只保留这些层**
        ...
        target_dir = "/research/cbim/medical/bg654/verse_dataset/AMOS_MRI/Data/train"
