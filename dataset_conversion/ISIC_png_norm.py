...
def process_existing_2d_data(dataset_info, source_path, target_path, file="train"):
    ...
    for name in os.listdir(img_dir):
        ...
        lab_path = os.path.join(lab_dir, f"{base_name}_segmentation.png")
...
source_path = "/research/cbim/medical/bg654/verse_dataset/ISIC/rescale_data"
target_path = "/research/cbim/medical/bg654/verse_dataset/ISIC/Data/"
